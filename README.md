...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdpyras-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12009&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdpyras-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdpyras` can be installed with:

```
conda install pdpyras
```

It is possible to list all of the versions of `pdpyras` available on your platform with:
